...
// which could complete the input query to make it a valid BIP39 word, including
// the empty string if an exact match was found.
type SearchResult struct {
	// ExactMatch is true if the input query is a valid BIP39 word. Indicates
	// that the first element of the Suffixes field will be the empty string.
	//
	...
	// input query to make it a valid BIP39 word.
	Suffixes []string
}
